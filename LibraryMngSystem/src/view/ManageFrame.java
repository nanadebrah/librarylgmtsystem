		...
		// ======== menuBar1 ========
		{
			...
			// ======== menu1 ========
			{
				...
				mnSetting.setIcon(new ImageIcon(getClass().getResource(
						LibImages.MENU_PRO_SETTING)));
				mnSetting.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_G,
						InputEvent.ALT_MASK));
				menu1.add(mnSetting);
				...
				mnLogout.setIcon(new ImageIcon(getClass().getResource(
						LibImages.MENU_LOGOUT)));
				mnLogout.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L,
						InputEvent.ALT_MASK));
				menu1.add(mnLogout);
				menu1.addSeparator();
				...
				mnQuit.setIcon(new ImageIcon(getClass().getResource(
						LibImages.MENU_QUIT)));
				mnQuit.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q,
						InputEvent.ALT_MASK));
				menu1.add(mnQuit);
			}
			menuBar1.add(menu1);
