...
public class SendAlertDialog extends JDialog {
	...
	private void initComponents() {
		...
		// ======== panel1 ========
		{
			...
			// ---- txtTo ----
			txtTo.setToolTipText("Email of employee");
			...
			txtFrom.setToolTipText("Your system email");
			...
			// ======== scrollPane1 ========
			{
				...
				// ---- txtContent ----
				txtContent.setToolTipText("Content of email");
				scrollPane1.setViewportView(txtContent);
			}
			panel1.add(scrollPane1, new GridBagConstraints(1, 3, 1, 2, 0.0,
