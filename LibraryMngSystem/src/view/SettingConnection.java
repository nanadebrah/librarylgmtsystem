...
public class SettingConnection extends JDialog {
	...
	private void initComponents() {
		...
		((GridBagLayout)contentPane.getLayout()).rowHeights = new int[] {247, 0, 0};
		...
		//---- lblImage ----
		lblImage.setIcon(new ImageIcon(getClass().getResource("/view/images/labelImages/Connect.png")));
		...
		//======== panel1 ========
		{
			panel1.setBorder(new CompoundBorder(
				new TitledBorder("Connection Setting"),
