/*
 * Created by JFormDesigner on Mon Jan 17 17:44:28 GMT+07:00 2011
 */
...
public class ViewBookDialog extends JDialog {
	...
	private void initComponents() {
		...
		((GridBagLayout)contentPane.getLayout()).columnWidths = new int[] {207, 500, 0};
		((GridBagLayout)contentPane.getLayout()).rowHeights = new int[] {234, 0, 0, 0};
		...
		//======== panel1 ========
		{
			panel1.setBorder(new CompoundBorder(
				new TitledBorder("Book Information"),
				new EmptyBorder(5, 5, 5, 5)));
			panel1.setLayout(new GridBagLayout());
			((GridBagLayout)panel1.getLayout()).columnWidths = new int[] {0, 393, 0};
		...
		//---- label1 ----
		label1.setIcon(new ImageIcon(getClass().getResource("/view/images/labelImages/InfoBook.png")));
		...
		//======== scrollPane1 ========
		{
			scrollPane1.setBorder(new TitledBorder("Book's Borrow Details"));
