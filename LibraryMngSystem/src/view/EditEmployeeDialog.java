/*
 * Created by JFormDesigner on Mon Jan 17 16:23:34 GMT+07:00 2011
 */
...
public class EditEmployeeDialog extends JDialog {
	public EditEmployeeDialog(Frame owner) {
		super(owner, true);
		initComponents();
	}

	public EditEmployeeDialog(Dialog owner) {
		super(owner);
		initComponents();
	}
	...
	private void initComponents() {
		...
		((GridBagLayout)contentPane.getLayout()).columnWidths = new int[] {171, 344, 0};
		((GridBagLayout)contentPane.getLayout()).rowHeights = new int[] {377, 0};
		...
		//---- label1 ----
		label1.setIcon(new ImageIcon(getClass().getResource("/view/images/labelImages/EditEmp.png")));
		...
		//======== panel1 ========
		{
			panel1.setBorder(new CompoundBorder(
				new TitledBorder("Employee Information"),
				new EmptyBorder(5, 5, 5, 5)));
			panel1.setLayout(new GridBagLayout());
			((GridBagLayout)panel1.getLayout()).columnWidths = new int[] {0, 98, 125, 0};
			...
			panel1.add(cbxPermission, new GridBagConstraints(1, 8, 2, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(0, 0, 5, 0), 0, 0));

			//---- btnSave ----
			btnSave.setText("Save");
			panel1.add(btnSave, new GridBagConstraints(1, 9, 1, 1, 0.0, 0.0,
