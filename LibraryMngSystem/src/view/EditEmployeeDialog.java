...
public class EditEmployeeDialog extends JDialog {
	...
	private void initComponents() {
		...
		((GridBagLayout) contentPane.getLayout()).columnWidths = new int[] {
				171, 344, 0 };
		((GridBagLayout) contentPane.getLayout()).rowHeights = new int[] { 377,
				0 };
		...
		label1.setIcon(new ImageIcon(getClass().getResource(
				"/view/images/labelImages/EditEmp.png")));
		...
		// ======== panel1 ========
		{
			...
			// ---- txtName ----
			txtName.setToolTipText("Name of employee");
			...
			// ---- txtDOB ----
			txtDOB.setToolTipText("Date of birth of employee");
			...
			// ---- txtAdd ----
			txtAdd.setToolTipText("Address of employee");
			...
			// ---- txtPass ----
			txtPass.setToolTipText("If is a librarian, need enter password");
			...
			// ---- txtEmail ----
			txtEmail.setToolTipText("Email to send alert due-date");
			...
			// ---- txtPhone ----
			txtPhone.setToolTipText("Phone of employee");
			...
			// ---- txtDepart ----
			txtDepart.setToolTipText("Department of employee");
