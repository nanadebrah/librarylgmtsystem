            ...
            .add(palAddBokLayout.createSequentialGroup()
                .add(palAddBokLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, palAddBokLayout.createSequentialGroup()
                        .add(246, 246, 246)
                        .add(lblNoInLib, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 87, Short.MAX_VALUE)
                        .add(63, 63, 63))
                    .add(palAddBokLayout.createSequentialGroup()
                        .add(124, 124, 124)
                        .add(txtNoCop, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
                        .add(167, 167, 167)
                        .add(txtNoInLib, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 51, Short.MAX_VALUE)
                        .add(4, 4, 4))
                    .add(palAddBokLayout.createSequentialGroup()
                        .add(127, 127, 127)
