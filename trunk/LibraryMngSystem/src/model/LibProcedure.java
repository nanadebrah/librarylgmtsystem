...
public class LibProcedure {
	 ...
	 */
	public static final String SEARCH_CHECKOUT_BY_BORID = "{call sp_SearhCheckOutByBorID(?)}";
	public static final String SEARCH_CHECKOUT_BY_BOOK_INFO = "{call sp_SearhCheckOutByBookInfo(?,?,?,?,?,?,?)}";
	public static final String SERCH_CHECKOUT_BY_EMPID = "{call sp_SearhCheckOutByEmpID(?,?,?,?)}";
	public static final String SEARCH_CHECKOUT_BY_EMPNAME = "{call sp_SearhCheckOutByEmpName(?,?,?,?)}";
	/**
	 * Check-in
	 */
	...
	public static final String GET_CHECKING_OUT = "{call sp_GetCheckingOutByDate(?,?,?,?)}";
}
