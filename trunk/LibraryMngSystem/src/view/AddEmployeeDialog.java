...
public class AddEmployeeDialog extends JDialog {
	...
	private void initComponents() {
		...
		((GridBagLayout)contentPane.getLayout()).columnWidths = new int[] {173, 0, 0};
		((GridBagLayout)contentPane.getLayout()).rowHeights = new int[] {372, 0};
		...
		//---- label1 ----
		label1.setIcon(new ImageIcon(getClass().getResource("/view/images/labelImages/AddEmp.png")));
