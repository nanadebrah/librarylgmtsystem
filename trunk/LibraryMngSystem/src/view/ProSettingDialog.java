...
public class ProSettingDialog extends JDialog {
	...
	private void initComponents() {
		...
		((GridBagLayout)contentPane.getLayout()).columnWidths = new int[] {220, 0, 0};
		((GridBagLayout)contentPane.getLayout()).rowHeights = new int[] {257, 29, 0};
		...
		//======== panel1 ========
		{
			panel1.setBorder(new CompoundBorder(
				new TitledBorder("General & Email"),
				new EmptyBorder(5, 5, 5, 5)));
			panel1.setLayout(new GridBagLayout());
			((GridBagLayout)panel1.getLayout()).columnWidths = new int[] {0, 155, 0};
			...
			//---- spinNoRow ----
			spinNoRow.setToolTipText("Number of row on a page");
			...
			//---- txtHost ----
			txtHost.setToolTipText("SMTP host of your email account");
			...
			//---- txtPort ----
			txtPort.setToolTipText("Port of your email host");
			...
			//---- txtPass ----
			txtPass.setToolTipText("Your email password");
