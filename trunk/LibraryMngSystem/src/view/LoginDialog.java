...
public class LoginDialog extends JDialog {
	...
	private void initComponents() {
		...
		((GridBagLayout) contentPane.getLayout()).columnWidths = new int[] { 0,
				275, 0 };
		((GridBagLayout) contentPane.getLayout()).rowHeights = new int[] { 164,
				0, 0 };
		...
		// ======== panel1 ========
		{
			panel1.setBorder(new CompoundBorder(new TitledBorder(
					...
					"Login Information"), new EmptyBorder(5, 5, 5, 5)));
			panel1.setLayout(new GridBagLayout());
			((GridBagLayout) panel1.getLayout()).columnWidths = new int[] { 71,
					0, 151, 0 };
			...
			// ---- txtUser ----
			txtUser.setToolTipText("Your system username");
			...
			// ---- txtPass ----
			txtPass.setToolTipText("Your system password");
			...
			panel1.add(cbxRemember, new GridBagConstraints(0, 2, 2, 1, 0.0,
